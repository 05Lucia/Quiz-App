...
let cssQuiz = [
    ...
    {
        "question": "What is the correct CSS syntax to select an element with id 'example'?",
        "answer_1": "id: example",
        "answer_2": ".example",
        "answer_3": "element.example",
        "answer_4": "#example",
        "right_answer": "4"
    },
    {
    ...
    },
    {
        ...
        "answer_1": "font-size: 16px",
        "answer_2": "text-size: 16px",
        "answer_3": "size: 16px",
        "answer_4": "font: 16px",
        "right_answer": "1"
    },
    {
        ...
        "answer_1": "border-size",
        "answer_2": "border-width",
        "answer_3": "border-style",
        "answer_4": "border",
        "right_answer": "2"
    },
    {
        "question": "What is the correct CSS syntax to make a text bold?",
        "answer_1": "bold: true",
        "answer_2": "text-weight: bold",
        "answer_3": "weight: bold",
        "answer_4": "font-weight: bold",
        "right_answer": "4"
    },
    {
...
function nextQuestion() {
    ...
    if (currentQuestion >= quizQuestions.length) {
        ...
        score()
        document.getElementById('main-contaniner'). innerHTML += `<img class="trophy" src="./img/tropy.png" alt="">`; 
    } else {
